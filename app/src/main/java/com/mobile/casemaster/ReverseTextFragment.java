...
public class ReverseTextFragment extends Fragment {
    ...
    public ReverseTextFragment() {}

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_reverse_text, container, false);
        ...
        btnConvert.setOnClickListener(v -> {
            ...
            textResult.setText(new StringBuilder(input).reverse().toString());
