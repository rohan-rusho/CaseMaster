...
public class LowercaseFragment extends Fragment {
    ...
    public LowercaseFragment() {}

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_lowercase, container, false);
        ...
        btnConvert.setOnClickListener(v -> {
            ...
            textResult.setText(input.toLowerCase());
